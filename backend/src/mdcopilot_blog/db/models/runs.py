...
class BlogRun(UUIDPk, Timestamps, Base):
    ...
    __table_args__ = (Index("ix_blog_runs_created_at", "created_at"),)
    ...
    # mdcopilot-backend users.id of the admin who started the run (no FK: another service owns that table)
